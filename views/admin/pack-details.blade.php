				...
				<div class="panel-body">
							...
							<tbody>
								...
								<tr class="gradeC">
									...
									<td>
										...
										Printed
										@elseif ($coupon['status'] == 2)
										<a href="admin-toggle-coupon.php?username={{ strtoupper($coupon['coupon']) }}&auth-type=Reject&batch-id={{ $batch_id }}" class="btn btn-danger">Disable</a>

										@elseif ($coupon['status'] == 3)
										<a href="admin-toggle-coupon.php?username={{ strtoupper($coupon['coupon']) }}&auth-type=Accept&batch-id={{ $batch_id }}" class="btn btn-success">Enable</a>
										@endif
									</td>
								</tr>
								@endforeach
					...
					<div class="row">
						...
						<form method="post" action="admin-pack-cancel-coupons.php" id="pack-cancel-form">
							...
							<div class="col-md-2">
								<label>&nbsp;</label><br />
								<button type="submit" class="btn btn-danger">Cancel Coupons</button>
							</div>
						</form>
