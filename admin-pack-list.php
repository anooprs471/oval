...
if ($user->isAdmin()) {
	...
	foreach ($batches as $batch) {
		...
		array_push($info, array(
			...
			'created_at' => \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $batch['created_at'])->format('M d Y'),
			// 'expires' => \Carbon\Carbon::createFromFormat('M d Y', $batch['expiry_on'])->format('Y M, d'),
			'expires' => $batch['expiry_on'],
		));
	}
